...
export const getProfileStyles = (C: any, TOP: number, BOTTOM: number) => StyleSheet.create({
  ...
  avatarRing: { width: 72, height: 72, borderRadius: 36, backgroundColor: C.surfaceMid, alignItems: 'center', justifyContent: 'center', borderWidth: 2, borderColor: C.primaryBorder, shadowColor: C.primary, shadowOpacity: 0.15, shadowRadius: 10 },
  ...
  heroPillGreen: { flexDirection: 'row', alignItems: 'center', gap: 4, backgroundColor: C.primaryLight, borderWidth: 1, borderColor: C.primaryBorder, paddingHorizontal: 9, paddingVertical: 4, borderRadius: 20 },
  heroPillOrange: { flexDirection: 'row', alignItems: 'center', gap: 4, backgroundColor: C.orangeLight, borderWidth: 1, borderColor: C.orangeBorder, paddingHorizontal: 9, paddingVertical: 4, borderRadius: 20 },
  heroPillBlue: { flexDirection: 'row', alignItems: 'center', gap: 4, backgroundColor: C.blueLight, borderWidth: 1, borderColor: C.blueBorder, paddingHorizontal: 9, paddingVertical: 4, borderRadius: 20 },
  heroPillGray: { flexDirection: 'row', alignItems: 'center', gap: 4, backgroundColor: C.surfaceMid, borderWidth: 1, borderColor: C.border, paddingHorizontal: 9, paddingVertical: 4, borderRadius: 20 },
  ...
  // Water
  waterCard: { backgroundColor: C.surface, borderRadius: 30, marginBottom: 14, borderWidth: 1, borderColor: C.blueBorder, shadowColor: C.blue, shadowOpacity: 0.15, shadowRadius: 20, elevation: 5, overflow: 'hidden', minHeight: 160 },
  waterInner: { padding: 22, zIndex: 10 },
  ...
  waterResetBtn: { width: 44, height: 44, borderRadius: 15, backgroundColor: C.surface, justifyContent: 'center', alignItems: 'center', borderWidth: 1, borderColor: C.borderLight },
